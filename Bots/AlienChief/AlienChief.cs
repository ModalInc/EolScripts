...
{   // Script Class
    ...
    {   ///////////////////////////////////////////////////
        ...
        public AlienChief(VehInfo.Car type, Helpers.ObjectState state, Arena arena, Script_Eol BaseScript)
        ...
        public override bool poll()
        {
            ...
            {//Dead
                ...
                _baseScript.roamingAlienBots.Remove(_team);
                _baseScript.alienChiefBots.Remove(_team);
                _baseScript._currentRoamChief--;
                _baseScript._tickLastChief = now;
                return base.poll();
            }
