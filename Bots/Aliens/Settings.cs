...
{   // Script Class
    ...
    public partial class Aliens : Bot
    {
        ...
        public float patrolDist = 2.1f;                     //The distance from our patrol points where we turn around and pursue the other point
        ...
        public const int c_pathUpdateInterval = 5000;      //The amount of ticks before a bot will renew it's path
